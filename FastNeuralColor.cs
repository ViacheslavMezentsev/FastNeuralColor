...
namespace FastNeuralColor{
  ...
  sealed class PreviewForm:System.Windows.Forms.Form{
    ...
    private void SaveImage(System.Object sender, System.EventArgs E){
      ...
      SaveImageDialog.Filter = "Изображения (*.bmp)|*.bmp|Изображения (*.emf)|*.emf|Изображения (*.exif)|*.exif|Изображения (*.gif)|*.gif|Изображения (*.ico)|*.ico|Изображения (*.jpg)|*.jpg|Изображения (*.png)|*.png|Изображения (*.tiff)|*.tiff|Изображения (*.wmf)|*.wmf";
      if (SaveImageDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK){
        try{
          ...
          System.Windows.Forms.MessageBox.Show("Не удалось сохранить изображение.", "Ошибка!");
        }
      }
    }
  }
  ...
  sealed class MainForm:System.Windows.Forms.Form{
    ...
    private unsafe void OpenImage(System.Object sender, System.EventArgs E){
      ...
      OpenImageDialog.Title = "Выберите изображение для окрашивания";
      OpenImageDialog.Filter = "Изображения (*.bmp; *.emf; *.exif; *.gif; *.ico; *.jpg; *.png; *.tiff; *.wmf)|*.bmp; *.emf; *.exif; *.gif; *.ico; *.jpg; *.png; *.tiff; *.wmf|Все файлы(*.*)|*.*";
    ...
    private void StopColorization(System.Object sender, System.EventArgs E){
      ...
      this.Text = "PABCSoft - FastNeuralColor: Прервано";
    }
    private unsafe void Colorize(){
      var Timer = System.DateTime.Now;
      this.Text = "PABCSoft - FastNeuralColor: Обрабатывается";
      this.StartStopToolStripMenuItem.Text = "Стоп";
      ...
      this.StartStopToolStripMenuItem.Click -= this.StopColorization;
      this.StartStopToolStripMenuItem.Click += this.StartColorization;
      this.Text = "PABCSoft - FastNeuralColor: Завершено за "+(System.DateTime.Now-Timer).TotalSeconds.ToString()+" секунд!";
      System.GC.Collect();
    }
    ...
    public MainForm(){
      ...
      this.ImageToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem("Изображение", new System.Drawing.Bitmap(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("Image.jpg")));
      //-> OpenImageToolStripMenuItem
      this.OpenImageToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem("Открыть", new System.Drawing.Bitmap(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("Open.png")), this.OpenImage);
      this.ImageToolStripMenuItem.DropDownItems.Add(this.OpenImageToolStripMenuItem);
      //-> SaveImageToolStripMenuItem
      this.SaveImageToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem("Сохранить", new System.Drawing.Bitmap(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("Save.png")), this.SaveImage);
      this.SaveImageToolStripMenuItem.Enabled = false;
      ...
      this.StartStopToolStripMenuItem = new ToolStripMenuItem("Старт", new System.Drawing.Bitmap(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("Start.png")), this.StartColorization);
      this.StartStopToolStripMenuItem.Enabled = false;
      this.MainToolStrip.Items.Add(this.StartStopToolStripMenuItem);
      //-> ExitToolStripMenuItem
      this.ExitToolStripMenuItem = new ToolStripMenuItem("Выход", new System.Drawing.Bitmap(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("Exit.png")), this.Close);
